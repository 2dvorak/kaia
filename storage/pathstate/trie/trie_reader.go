...
//
// This file is derived from trie/trie_reader.go (go-ethereum v1.13.15). The
// concrete triedb/database dependency is replaced by the local database/Reader
...
func newTrieReader(stateRoot, owner common.Hash, db database) (*trieReader, error) {
	if stateRoot == (common.Hash{}) || stateRoot == EmptyRootHash {
		if stateRoot == (common.Hash{}) {
			logger.Error("Zero state root hash!")
		}
