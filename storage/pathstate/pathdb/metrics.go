...
//
// This file is derived from triedb/pathdb/metrics.go (go-ethereum v1.13.15).
// The go-ethereum metrics package is replaced by github.com/rcrowley/go-metrics
// (the same fork Kaia uses elsewhere) and the state-history metrics are dropped
// since state history is disabled in this port.
