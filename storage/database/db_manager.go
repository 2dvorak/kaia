...
type databaseManager struct {
	...
	// pruningState memoizes the persisted pruning flag (0 unread, 1 on,
	// 2 off) so ReadPruningEnabled skips a leveldb.Has on every state.New.
...
// Memoized via pruningState; only mutates through Write/DeletePruningEnabled.
