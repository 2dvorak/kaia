...
func TestTest(t *testing.T) {
	items := []struct {
		...
		{common.Hex2Bytes("de20ec601c1d770a9ec6e89b2639cd63203514c4"), common.Hex2Bytes("01f849c580808001c0a056e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421a0de75942ed4731d491798b4a82bc5937553e715a97b76fc5987e35ee3cd2ee68380"), common.Hex2Bytes("7e648a4218cc03a978b710ca2966333d630c73314825cd9f430c86d543aa1187")},
		{common.Hex2Bytes("e8170332ea5a606146e5a9e9deb8dcec0287047c"), common.Hex2Bytes("01c580808001c0"), common.Hex2Bytes("8e541bc90790b12cc381ae5e2b2161d7ab7060ebccd1fbf617ad13d071364181")},
		{common.Hex2Bytes("fe90e344274e129d656e03ffd0d0dc0b6518788d"), common.Hex2Bytes("01e680640102a1038318535b54105d4a7aae60c08fc45f9687181b4fdfc625bd1a753fa7397fed75"), common.Hex2Bytes("2b68354d781873ce324628a9e080aa2aec675c582d831aa94e2653a9cae06a00")},
		{common.Hex2Bytes("7bdf109bf068c37c97d5c84196417e034320f3fc"), common.Hex2Bytes("01c781c881c88001c0"), common.Hex2Bytes("bfb553f21a65a785cf6bf9746419661f5f20a05e8f45496880f7507db310fbe1")},
		{common.Hex2Bytes("69470b1abc45767a122bc5ebb6d8a1c97e4ff935"), common.Hex2Bytes("01f84bc782012c808001c0a056e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421a0d058a2d3336759c22976856de49b828b8282e64b9d2b2d0d0d94fc44928d8e4c80"), common.Hex2Bytes("40693f77f3ff6da65e70d7f19bcc37e189639c295d9003631b811bbfacea61e5")},
		{common.Hex2Bytes("115cd038daf5cc477c7116beab167e550f41b0d4"), common.Hex2Bytes("01c7820190808001c0"), common.Hex2Bytes("d22ba99e1ccd13ed9613a59fbe49c9c3ebe62dc86ba9ceb61b55d9f7703da7a8")},
		{common.Hex2Bytes("74ef9c1339963462581a5b96720711e7cfec22eb"), common.Hex2Bytes("01f84bc7808201f48001c0a056e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421a067cbae6de159c9d9be7017bb0a3b6be6770c0233c5f4d476523728e0520ca7bb80"), common.Hex2Bytes("123adc80990e80633b68f06893acd3ae23061ebbb4d8219232747799e130bc17")},
		{common.Hex2Bytes("5d76c9950b78dcfa47ec195f56d11a4afa8708f3"), common.Hex2Bytes("01f84dc98202588202588001c0a056e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421a02a5787ab5c11885b8b30f1a3aea5c05d48e17eb18f94210555e34a3a965b655a80"), common.Hex2Bytes("447b5cdd48dc3a9863a703fb2362cd1e41a5547fdd74b88201868406081754c2")},
	}
	...
	for _, item := range items {
		...
		if !bytes.Equal(item.root, hash2.Bytes()) {
			t.Errorf("expected %x got %x", item.root, hash2)
		}
	}
	root := trie.Hash()
	fmt.Printf("root: %x\n", root)
